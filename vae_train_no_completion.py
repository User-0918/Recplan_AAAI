...
class VAE_no_completion():
    def __init__(self,args,domain,train_loader,test_loader,model):        
        ...
        # for epoch in tqdm(range(1, 2)):
            ...
            train_bce_rec, train_kld_rec, train_no_change,train_change = self.train(args,model,train_loader,optimizer_model,epoch)
            test_bce_rec, test_kld_rec, test_no_change,test_change = self.test(args,model,test_loader,optimizer_model,epoch)
    ...
    def train(self,args,model,train_loader,optimizer_model,epoch):
        model.module.train()
    ...
    def test(self,args,model,test_loader,optimizer_model,epoch):
        model.module.eval()
        # model_probability.module.eval()
        bce_loss_rec = 0.0
        kld_loss_rec = 0.0
