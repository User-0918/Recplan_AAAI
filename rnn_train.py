...
class RNN():
    def __init__(self,args,domain,train_loader,test_loader,model_probability,model,model_rnn):
        ...
        # for epoch in tqdm(range(1, 200)):
            ...
            train_bce_rec, train_kld_rec, train_bce_pred,train_kld_pred,train_bce_no_change,train_bce_state = self.train(args,model,model_probability,model_rnn,train_loader,optimizer,epoch)
            test_bce_rec, test_kld_rec, test_bce_pred,test_kld_pred,test_bce_state = self.test(args,model,model_probability,model_rnn,test_loader,optimizer,epoch)
    ...
    def train(self,args,model,model_probability,model_rnn,train_loader,optimizer,epoch):
        model.module.eval()
        ...
        for batch_idx, data in enumerate(train_loader):
            ...
            no_change_set_2 = []
    ###################################################################
            init_tensor = no_change_image[:,0].view(args.batch_size,1,*args.image_shape)
            ...
            for i in range(1,args.trace_len):
                ...
                z_know, pred_qy, hidden_state = model_rnn(z, action_tensor[:,i], hidden_state)
                pred_rec = model.module.Decoder(z_know, args.batch_size,1)
                ...
                predict_state_set.append(z_know )
    ...
    def test(self,args,model,model_probability,model_rnn,test_loader,optimizer,epoch):
        model.module.eval()
        model_probability.module.eval()
    ...
    ###################################################################
            ...
            for i in range(1,args.problem_trace_len):
                ...
                z = z.view(args.batch_size,args.cate_num,args.cate_dim-1)
